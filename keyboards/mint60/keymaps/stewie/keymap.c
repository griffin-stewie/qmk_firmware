...
#define KC_MAC_EISU KC_LANG2
#define KC_MAC_KANA KC_LANG1
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT( \
    ...
    KC_ESC,    KC_LALT,    KC_LCMD,    KC_MAC_EISU,    KC_SPC,        KC_SPC, KC_MAC_KANA,  KC_RCMD,               KC_LEFT,KC_DOWN,KC_RGHT \
  ),
  [1] = LAYOUT( \
    ...
    LCMD(KC_F1),   _______,    _______,    _______,    XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX,                   KC_HOME, KC_PGDN, KC_END \
  )
};
